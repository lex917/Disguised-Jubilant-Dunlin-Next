  ...
  return (
    <>
      <div className="home-container">
        <Head>
          <title>Disguised Jubilant Dunlin</title>
          <meta property="og:title" content="Disguised Jubilant Dunlin" />
        </Head>
        <Navbar8
          link1={
            <Fragment>
        ...
        <Pricing14
          ...
          plan1Price={
            <Fragment>
              <span className="home-text142">$20/mo</span>
            </Fragment>
          }
          plan2Price={
            <Fragment>
              <span className="home-text143">$29/mo</span>
            </Fragment>
          }
          plan3Price={
            <Fragment>
              <span className="home-text144">$49/mo</span>
            </Fragment>
          }
          plan1Action={
            <Fragment>
        ...
        <Steps2
          step1Title={
            <Fragment>
              <span className="home-text184">Step 1</span>
            </Fragment>
          }
          step2Title={
            <Fragment>
              <span className="home-text185">Step 2</span>
            </Fragment>
          }
          step3Title={
            <Fragment>
              <span className="home-text186">Step 3</span>
            </Fragment>
          }
          step4Title={
            <Fragment>
              <span className="home-text187">Step 4</span>
            </Fragment>
          }
          step1Description={
            <Fragment>
        ...
        <Testimonial17
          ...
          author1Name={
            <Fragment>
              <span className="home-text198">Author Name</span>
            </Fragment>
          }
          author2Name={
            <Fragment>
              <span className="home-text199">Author Name</span>
            </Fragment>
          }
          author3Name={
            <Fragment>
              <span className="home-text200">Author Name</span>
            </Fragment>
          }
          author4Name={
            <Fragment>
              <span className="home-text201">Author Name</span>
            </Fragment>
          }
          author1Position={
            <Fragment>
              <span className="home-text202">Position, Company name</span>
            </Fragment>
          }
          author2Position={
            <Fragment>
              <span className="home-text203">Position, Company name</span>
            </Fragment>
          }
          author3Position={
            <Fragment>
              <span className="home-text204">Position, Company name</span>
            </Fragment>
          }
          author4Position={
            <Fragment>
              <span className="home-text205">Position, Company name</span>
            </Fragment>
          }
        ></Testimonial17>
        <Contact10
