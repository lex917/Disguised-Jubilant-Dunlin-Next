          ...
          <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
            <nav className="navbar8-links1">
              ...
              >
                {props.link1 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Link 1</span>
                  </Fragment>
                )}
              </a>
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text25">Link 3</span>
                  </Fragment>
                )}
              </a>
              <div
                  ...
                  <div className="navbar8-menu-item6">
                    ...
                    <div className="navbar8-content6">
                      <span className="navbar8-page22 thq-body-large">
                        {props.page2 ?? (
                          <Fragment>
                            <span className="navbar8-text27">Page Two</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="thq-body-small">
                  ...
                  <div className="navbar8-menu-item8">
                    ...
                    <div className="navbar8-content8">
                      <span className="navbar8-page42 thq-body-large">
                        {props.page4 ?? (
                          <Fragment>
                            <span className="navbar8-text21">Page Four</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="thq-body-small">
